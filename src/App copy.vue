...
<script>
import { h, ref, defineComponent, defineAsyncComponent, customRef, onMounted, watch, toRefs, readonly, shallowReadonly, computed, reactive, watchEffect, toRef } from 'vue';
// 一个单独的功能模块
import getNames from './composable/getNames';
import Props from './components/props.vue';
import hook1 from './hooks/hook1';
import hook2 from './hooks/hook2';
// defineAsyncComponent 异步引入， 动态引入
// const getNames = defineAsyncComponent(() => import('./composable/getNames'));
